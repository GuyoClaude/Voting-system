        ...
        <div class="main-wrapper">
            ...
            <?php
              if (isset($_SESSION['u_id'])) {
                  ...
                  <h3 class="info">Kibra Contituency.</h3>
            ...
            <div class="responsive">
              <div class="gallery">
                  ...
                  <img src="img/William.jpg" alt="Forest" width="400" height="400">
               
                <div class="desc"><input type="radio" name="for_mp" value="William Chirchir" checked> William Chirchir<br></div>
              </div>
            </div>
            ...
            <div class="responsive">
              <div class="gallery">
                  ...
                  <img src="img/Korir.jpg" alt="Forest" width="400" height="400">
               
                <div class="desc"> <input type="radio" name="for_mp" value="Nickson Korir"> Nickson Korir<br></div>
              </div>
            </div>
            ...
            <div class="responsive">
              <div class="gallery">
                  ...
                  <img src="img/okoth.jpg" alt="Forest" width="400" height="400">

                <div class="desc"> <input type="radio" name="for_mp" value="Ken Okoth"> &nbsp; Ken Okoth<br></div>
              </div>
            </div>
            </div>
