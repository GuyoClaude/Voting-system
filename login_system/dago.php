        ...
        <div class="main-wrapper">
            ...
            <?php
              if (isset($_SESSION['u_id'])) {
                  ...
                  <h3 class="info">Starehe Contiuency.</h3>
            ...
            <div class="responsive">
              <div class="gallery">
               ...
               <h4 class="pres">Starehe Member of Parliament</h4>
               <div class="gall">
            <div class="responsive">
              <div class="gallery">
               
                  <img src="img/chege.jpg" alt="Forest" width="400" height="400">
               
                <div class="desc"><input type="radio" name="for_mp" value="Chege Mwaura" checked> Chege Mwaura<br></div>
              </div>
            </div>
            ...
            <div class="responsive">
              <div class="gallery">
                  ...
                  <img src="img/Jaguar.jpg" alt="Forest" width="400" height="400">
               
                <div class="desc"> <input type="radio" name="for_mp" value="Charles Njagua"> Charles Njagua<br></div>
              </div>
            </div>
            ...
            <div class="responsive">
              <div class="gallery">
                  ...
                  <img src="img/boni.jpg" alt="Forest" width="400" height="400">

                <div class="desc"> <input type="radio" name="for_mp" value="Boniface Mwangi">Boniface Mwangi<br></div>
              </div>
            </div>
            </div>
